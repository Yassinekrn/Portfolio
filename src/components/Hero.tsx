    ...
    useEffect(() => {
        ...
        const updateTitlePosition = () => {
            ...
            setTitlePosition((prev) => ({
                x:
                    prev.x +
                    (mousePosition.x * 20 - prev.x) * followSpeed.current,
                y:
                    prev.y +
                    (mousePosition.y * 20 - prev.y) * followSpeed.current,
            }));
            ...
            <div className="container mx-auto px-4 z-10">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    >
                        ...
                        <motion.a
                            href="#contact"
                            className="px-6 py-3 rounded-full text-lg font-medium border-2 border-black dark:border-white dark:text-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
                            Let's Connect
